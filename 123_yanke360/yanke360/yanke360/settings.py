# -*- coding: utf-8 -*-
BOT_NAME='yanke360'
SPIDER_MODULES=['yanke360.spiders']
NEWSPIDER_MODULE='yanke360.spiders'
...
ITEM_PIPELINES= {
	'yanke360.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'yanke360.stats_collector_global.PrintCoreMetrics': 500,
	'yanke360.stats_mail_global.StatsMailer': 505,
}
