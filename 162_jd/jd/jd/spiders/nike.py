    ...
    def parse(self, response):
        ...
        if count:
            ...
            for i in xrange(1, count):
                url = 'https://module-jshop.jd.com/module/allGoods/goods.html?appId=1005989&pageInstanceId=103275864&searchWord=&pageNo='+ str(i) +'&direction=1&instanceId=103275867&modulePrototypeId=55555&moduleTemplateId=905542'
                headers = {
