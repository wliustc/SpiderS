# -*- coding: utf-8 -*-
BOT_NAME='jd_real_time'
SPIDER_MODULES=['jd_real_time.spiders']
NEWSPIDER_MODULE='jd_real_time.spiders'
...
ITEM_PIPELINES= {
	'jd_real_time.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'jd_real_time.stats_collector_global.PrintCoreMetrics': 500,
	'jd_real_time.stats_mail_global.StatsMailer': 505,
}
