# -*- coding: utf-8 -*-
BOT_NAME='jd_shangzhi'
SPIDER_MODULES=['jd_shangzhi.spiders']
NEWSPIDER_MODULE='jd_shangzhi.spiders'
...
ITEM_PIPELINES= {
	'jd_shangzhi.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'jd_shangzhi.stats_collector_global.PrintCoreMetrics': 500,
	'jd_shangzhi.stats_mail_global.StatsMailer': 505,
}
