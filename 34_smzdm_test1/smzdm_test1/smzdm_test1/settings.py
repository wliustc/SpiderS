# -*- coding: utf-8 -*-
BOT_NAME='smzdm_test1'
SPIDER_MODULES=['smzdm_test1.spiders']
NEWSPIDER_MODULE='smzdm_test1.spiders'
...
ITEM_PIPELINES= {
	'smzdm_test1.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='INFO'
...
MAIL_PASS="dev@123"
EXTENSIONS= {
	'smzdm_test1.stats_collector_global.PrintCoreMetrics': 500,
}
SAVE_PATH='data'
