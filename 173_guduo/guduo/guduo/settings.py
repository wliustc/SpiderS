# -*- coding: utf-8 -*-
BOT_NAME='guduo'
SPIDER_MODULES=['guduo.spiders']
NEWSPIDER_MODULE='guduo.spiders'
...
ITEM_PIPELINES= {
	'guduo.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'guduo.stats_collector_global.PrintCoreMetrics': 500,
	'guduo.stats_mail_global.StatsMailer': 505,
}
