...
def parse(line):
    try:
        ...
        category2_id = meta.get('category2_id')
        category2_name = meta.get('category2_name')
        shopRecordBean = meta.get('shopRecordBean')
    
        shopRecordBean = shopRecordBean.get('shopRecordBean')
        item = {}
        # print shopRecordBean
        # shopRecordBean = shopRecordBeanl.get('shopRecordBean')
        # print shopRecordBean
        ...
        if hits:
            ...
            item['hits'] = 0
        # item['month_hits'] = shopInfo.get('monthlyHits')
        ...
        item['wish_total'] = shopRecordBean.get('wishTotal')
        item['dt'] = time.strftime('%Y-%m-%d', time.localtime())
        # item['prev_weekly_hits'] = shopInfo.get('prevWeeklyHits')
        ...
        # item['today_hits'] =shopInfo.get('todayHits')
        ...
        # item['weekly_hits'] = shopInfo.get('weeklyHits')
        ...
        print e
        print shopRecordBean.get('shopId')
