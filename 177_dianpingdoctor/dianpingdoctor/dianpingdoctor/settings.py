# -*- coding: utf-8 -*-
BOT_NAME='dianpingdoctor'
SPIDER_MODULES=['dianpingdoctor.spiders']
NEWSPIDER_MODULE='dianpingdoctor.spiders'
...
ITEM_PIPELINES= {
	'dianpingdoctor.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'dianpingdoctor.stats_collector_global.PrintCoreMetrics': 500,
	'dianpingdoctor.stats_mail_global.StatsMailer': 505,
}
