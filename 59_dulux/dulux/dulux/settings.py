# -*- coding: utf-8 -*-
BOT_NAME='dulux'
SPIDER_MODULES=['dulux.spiders']
NEWSPIDER_MODULE='dulux.spiders'
...
ITEM_PIPELINES= {
	'dulux.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'dulux.stats_collector_global.PrintCoreMetrics': 500,
	'dulux.stats_mail_global.StatsMailer': 505,
}
