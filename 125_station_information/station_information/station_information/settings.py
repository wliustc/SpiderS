# -*- coding: utf-8 -*-
BOT_NAME='station_information'
SPIDER_MODULES=['station_information.spiders']
NEWSPIDER_MODULE='station_information.spiders'
...
ITEM_PIPELINES= {
	'station_information.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'station_information.stats_collector_global.PrintCoreMetrics': 500,
	'station_information.stats_mail_global.StatsMailer': 505,
}
