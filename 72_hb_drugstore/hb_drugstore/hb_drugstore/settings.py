# -*- coding: utf-8 -*-
BOT_NAME='hb_drugstore'
SPIDER_MODULES=['hb_drugstore.spiders']
NEWSPIDER_MODULE='hb_drugstore.spiders'
...
ITEM_PIPELINES= {
	'hb_drugstore.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'hb_drugstore.stats_collector_global.PrintCoreMetrics': 500,
	'hb_drugstore.stats_mail_global.StatsMailer': 505,
}
