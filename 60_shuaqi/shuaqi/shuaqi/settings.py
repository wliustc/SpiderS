# -*- coding: utf-8 -*-
BOT_NAME='shuaqi'
SPIDER_MODULES=['shuaqi.spiders']
NEWSPIDER_MODULE='shuaqi.spiders'
...
ITEM_PIPELINES= {
	'shuaqi.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
MAIL_PASS="dev123"
EXTENSIONS= {
	'shuaqi.stats_collector_global.PrintCoreMetrics': 500,
	'shuaqi.stats_mail_global.StatsMailer': 505,
}
