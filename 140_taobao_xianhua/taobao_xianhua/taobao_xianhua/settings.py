# -*- coding: utf-8 -*-
BOT_NAME='taobao_xianhua'
SPIDER_MODULES=['taobao_xianhua.spiders']
NEWSPIDER_MODULE='taobao_xianhua.spiders'
...
ITEM_PIPELINES= {
	'taobao_xianhua.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'taobao_xianhua.stats_collector_global.PrintCoreMetrics': 500,
	'taobao_xianhua.stats_mail_global.StatsMailer': 505,
}
