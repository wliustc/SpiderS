# -*- coding: utf-8 -*-
BOT_NAME='yanke_haodaifu'
SPIDER_MODULES=['yanke_haodaifu.spiders']
NEWSPIDER_MODULE='yanke_haodaifu.spiders'
...
ITEM_PIPELINES= {
	'yanke_haodaifu.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'yanke_haodaifu.stats_collector_global.PrintCoreMetrics': 500,
	'yanke_haodaifu.stats_mail_global.StatsMailer': 505,
}
