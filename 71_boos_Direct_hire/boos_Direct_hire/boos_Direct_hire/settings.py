# -*- coding: utf-8 -*-
BOT_NAME='boos_Direct_hire'
SPIDER_MODULES=['boos_Direct_hire.spiders']
NEWSPIDER_MODULE='boos_Direct_hire.spiders'
...
ITEM_PIPELINES= {
	'boos_Direct_hire.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'boos_Direct_hire.stats_collector_global.PrintCoreMetrics': 500,
	'boos_Direct_hire.stats_mail_global.StatsMailer': 505,
}
