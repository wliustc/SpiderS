# -*- coding: utf-8 -*-
BOT_NAME='dianping_'
SPIDER_MODULES=['dianping_.spiders']
NEWSPIDER_MODULE='dianping_.spiders'
...
ITEM_PIPELINES= {
	'dianping_.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'dianping_.stats_collector_global.PrintCoreMetrics': 500,
	'dianping_.stats_mail_global.StatsMailer': 505,
}
