# -*- coding: utf-8 -*-
BOT_NAME='weipin'
SPIDER_MODULES=['weipin.spiders']
NEWSPIDER_MODULE='weipin.spiders'
...
ITEM_PIPELINES= {
	'weipin.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'weipin.stats_collector_global.PrintCoreMetrics': 500,
	'weipin.stats_mail_global.StatsMailer': 505,
}
