# -*- coding: utf-8 -*-
BOT_NAME='tyc_update'
SPIDER_MODULES=['tyc_update.spiders']
NEWSPIDER_MODULE='tyc_update.spiders'
...
ITEM_PIPELINES= {
	'tyc_update.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'tyc_update.stats_collector_global.PrintCoreMetrics': 500,
	'tyc_update.stats_mail_global.StatsMailer': 505,
}
