# -*- coding: utf-8 -*-
BOT_NAME='testzz'
SPIDER_MODULES=['testzz.spiders']
NEWSPIDER_MODULE='testzz.spiders'
...
ITEM_PIPELINES= {
	'testzz.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'testzz.stats_collector_global.PrintCoreMetrics': 500,
	'testzz.stats_mail_global.StatsMailer': 505,
}
