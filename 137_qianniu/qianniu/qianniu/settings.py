# -*- coding: utf-8 -*-
BOT_NAME='qianniu'
SPIDER_MODULES=['qianniu.spiders']
NEWSPIDER_MODULE='qianniu.spiders'
...
ITEM_PIPELINES= {
	'qianniu.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'qianniu.stats_collector_global.PrintCoreMetrics': 500,
	'qianniu.stats_mail_global.StatsMailer': 505,
}
