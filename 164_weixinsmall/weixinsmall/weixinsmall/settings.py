...
ITEM_PIPELINES= {
	'weixinsmall.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'weixinsmall.stats_collector_global.PrintCoreMetrics': 500,
	'weixinsmall.stats_mail_global.StatsMailer': 505,
}
