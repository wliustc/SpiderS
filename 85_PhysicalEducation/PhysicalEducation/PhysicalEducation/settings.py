# -*- coding: utf-8 -*-
BOT_NAME='PhysicalEducation'
SPIDER_MODULES=['PhysicalEducation.spiders']
NEWSPIDER_MODULE='PhysicalEducation.spiders'
...
ITEM_PIPELINES= {
	'PhysicalEducation.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'PhysicalEducation.stats_collector_global.PrintCoreMetrics': 500,
	'PhysicalEducation.stats_mail_global.StatsMailer': 505,
}
