# -*- coding: utf-8 -*-
BOT_NAME='Jdpaint'
SPIDER_MODULES=['Jdpaint.spiders']
NEWSPIDER_MODULE='Jdpaint.spiders'
...
ITEM_PIPELINES= {
	'Jdpaint.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'Jdpaint.stats_collector_global.PrintCoreMetrics': 500,
	'Jdpaint.stats_mail_global.StatsMailer': 505,
}
