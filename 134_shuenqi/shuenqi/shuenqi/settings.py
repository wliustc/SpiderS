# -*- coding: utf-8 -*-
BOT_NAME='shuenqi'
SPIDER_MODULES=['shuenqi.spiders']
NEWSPIDER_MODULE='shuenqi.spiders'
...
ITEM_PIPELINES= {
	'shuenqi.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'shuenqi.stats_collector_global.PrintCoreMetrics': 500,
	'shuenqi.stats_mail_global.StatsMailer': 505,
}
