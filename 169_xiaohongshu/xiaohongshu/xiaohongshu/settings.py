...
ITEM_PIPELINES= {
	'xiaohongshu.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'xiaohongshu.stats_collector_global.PrintCoreMetrics': 500,
	'xiaohongshu.stats_mail_global.StatsMailer': 505,
}
