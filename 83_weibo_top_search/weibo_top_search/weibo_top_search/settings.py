# -*- coding: utf-8 -*-
BOT_NAME='weibo_top_search'
SPIDER_MODULES=['weibo_top_search.spiders']
NEWSPIDER_MODULE='weibo_top_search.spiders'
...
ITEM_PIPELINES= {
	'weibo_top_search.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'weibo_top_search.stats_collector_global.PrintCoreMetrics': 500,
	'weibo_top_search.stats_mail_global.StatsMailer': 505,
}
