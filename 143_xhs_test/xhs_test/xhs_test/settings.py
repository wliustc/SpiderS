# -*- coding: utf-8 -*-
BOT_NAME='xhs_test'
SPIDER_MODULES=['xhs_test.spiders']
NEWSPIDER_MODULE='xhs_test.spiders'
...
ITEM_PIPELINES= {
	'xhs_test.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'xhs_test.stats_collector_global.PrintCoreMetrics': 500,
	'xhs_test.stats_mail_global.StatsMailer': 505,
}
