# -*- coding: utf-8 -*-
BOT_NAME='sport_weibo'
SPIDER_MODULES=['sport_weibo.spiders']
NEWSPIDER_MODULE='sport_weibo.spiders'
...
ITEM_PIPELINES= {
	'sport_weibo.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'sport_weibo.stats_collector_global.PrintCoreMetrics': 500,
	'sport_weibo.stats_mail_global.StatsMailer': 505,
}
