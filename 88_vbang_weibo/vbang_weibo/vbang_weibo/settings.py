# -*- coding: utf-8 -*-
BOT_NAME='vbang_weibo'
SPIDER_MODULES=['vbang_weibo.spiders']
NEWSPIDER_MODULE='vbang_weibo.spiders'
...
ITEM_PIPELINES= {
	'vbang_weibo.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'vbang_weibo.stats_collector_global.PrintCoreMetrics': 500,
	'vbang_weibo.stats_mail_global.StatsMailer': 505,
}
