...
class CwssSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):  # 继承并初始化函数
        ...
        self.rim_url = 'http://restapi.amap.com/v3/place/text?key={key}&types=090203&city={city}&children=1&page={pag}&offset=50&page=1&extensions=all'
        # self.rim_url = 'http://restapi.amap.com/v3/place/text?key={key}&city={city}&keywords=格力空调|美的空调|海尔空调&children=1&page={pag}&offset=50&page=1&extensions=all'
        self.start_urls = []
