# -*- coding: utf-8 -*-
BOT_NAME='liangpin'
SPIDER_MODULES=['liangpin.spiders']
NEWSPIDER_MODULE='liangpin.spiders'
...
ITEM_PIPELINES= {
	'liangpin.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'liangpin.stats_collector_global.PrintCoreMetrics': 500,
	'liangpin.stats_mail_global.StatsMailer': 505,
}
