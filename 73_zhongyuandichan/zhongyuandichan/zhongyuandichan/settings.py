# -*- coding: utf-8 -*-
BOT_NAME='zhongyuandichan'
SPIDER_MODULES=['zhongyuandichan.spiders']
NEWSPIDER_MODULE='zhongyuandichan.spiders'
...
ITEM_PIPELINES= {
	'zhongyuandichan.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
RETRY_TIMES = 10
DOWNLOAD_TIMEOUT = 10
RETRY_HTTP_CODES = [500,503,504,400,408,404,403]
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'zhongyuandichan.stats_collector_global.PrintCoreMetrics': 500,
	'zhongyuandichan.stats_mail_global.StatsMailer': 505,
}
