# -*- coding: utf-8 -*-
BOT_NAME='hospital_project'
SPIDER_MODULES=['hospital_project.spiders']
NEWSPIDER_MODULE='hospital_project.spiders'
...
ITEM_PIPELINES= {
	'hospital_project.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'hospital_project.stats_collector_global.PrintCoreMetrics': 500,
	'hospital_project.stats_mail_global.StatsMailer': 505,
}
