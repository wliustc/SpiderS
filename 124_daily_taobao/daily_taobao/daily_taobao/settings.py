# -*- coding: utf-8 -*-
BOT_NAME='daily_taobao'
SPIDER_MODULES=['daily_taobao.spiders']
NEWSPIDER_MODULE='daily_taobao.spiders'
...
ITEM_PIPELINES= {
	'daily_taobao.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'daily_taobao.stats_collector_global.PrintCoreMetrics': 500,
	'daily_taobao.stats_mail_global.StatsMailer': 505,
}
