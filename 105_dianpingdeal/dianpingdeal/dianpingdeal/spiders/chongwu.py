...
class ChongwuJobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # yield Request('https://www.dianping.com/search/category/8/95/g25148m3',callback=self.parse,meta={'city_id': 8, 'city_name': '成都', 'page': 1, 'failure_time': 0},dont_filter=True, headers=header, errback=self.parse_failure)
    ...
    def parse(self, response):
        ...
        if shop_list:
            for shop_like in shop_list:
                ...
                if shop_id:
                    shop_id = shop_id.replace('http://www.dianping.com/shop/','').replace('/shop/','')
                else:
                    shop_id=0
