# -*- coding: utf-8 -*-
BOT_NAME='ajkRenting'
SPIDER_MODULES=['ajkRenting.spiders']
NEWSPIDER_MODULE='ajkRenting.spiders'
...
ITEM_PIPELINES= {
	'ajkRenting.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'ajkRenting.stats_collector_global.PrintCoreMetrics': 500,
	'ajkRenting.stats_mail_global.StatsMailer': 505,
}
