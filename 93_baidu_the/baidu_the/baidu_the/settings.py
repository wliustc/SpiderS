# -*- coding: utf-8 -*-
BOT_NAME='baidu_the'
SPIDER_MODULES=['baidu_the.spiders']
NEWSPIDER_MODULE='baidu_the.spiders'
...
ITEM_PIPELINES= {
	'baidu_the.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'baidu_the.stats_collector_global.PrintCoreMetrics': 500,
	'baidu_the.stats_mail_global.StatsMailer': 505,
}
