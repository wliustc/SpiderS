# -*- coding: utf-8 -*-
BOT_NAME='gd_cwss'
SPIDER_MODULES=['gd_cwss.spiders']
NEWSPIDER_MODULE='gd_cwss.spiders'
...
ITEM_PIPELINES= {
	'gd_cwss.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'gd_cwss.stats_collector_global.PrintCoreMetrics': 500,
	'gd_cwss.stats_mail_global.StatsMailer': 505,
}
