# -*- coding: utf-8 -*-
BOT_NAME='vip_spider'
SPIDER_MODULES=['vip_spider.spiders']
NEWSPIDER_MODULE='vip_spider.spiders'
...
ITEM_PIPELINES= {
	'vip_spider.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'vip_spider.stats_collector_global.PrintCoreMetrics': 500,
	'vip_spider.stats_mail_global.StatsMailer': 505,
}
