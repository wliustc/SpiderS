# -*- coding: utf-8 -*-
BOT_NAME='universities'
SPIDER_MODULES=['universities.spiders']
NEWSPIDER_MODULE='universities.spiders'
...
ITEM_PIPELINES= {
	'universities.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'universities.stats_collector_global.PrintCoreMetrics': 500,
	'universities.stats_mail_global.StatsMailer': 505,
}
