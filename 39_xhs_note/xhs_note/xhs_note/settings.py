# -*- coding: utf-8 -*-
BOT_NAME='xhs_note'
SPIDER_MODULES=['xhs_note.spiders']
NEWSPIDER_MODULE='xhs_note.spiders'
...
ITEM_PIPELINES= {
	'xhs_note.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='INFO'
...
MAIL_PASS="dev123"
EXTENSIONS= {
	'xhs_note.stats_collector_global.PrintCoreMetrics': 500,
	'scrapy.extensions.statsmailer.StatsMailer': 505,
}
