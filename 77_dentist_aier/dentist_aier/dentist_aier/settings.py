# -*- coding: utf-8 -*-
BOT_NAME='dentist_aier'
SPIDER_MODULES=['dentist_aier.spiders']
NEWSPIDER_MODULE='dentist_aier.spiders'
...
ITEM_PIPELINES= {
	'dentist_aier.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'dentist_aier.stats_collector_global.PrintCoreMetrics': 500,
	'dentist_aier.stats_mail_global.StatsMailer': 505,
}
