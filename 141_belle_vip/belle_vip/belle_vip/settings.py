# -*- coding: utf-8 -*-
BOT_NAME='belle_vip'
SPIDER_MODULES=['belle_vip.spiders']
NEWSPIDER_MODULE='belle_vip.spiders'
...
ITEM_PIPELINES= {
	'belle_vip.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'belle_vip.stats_collector_global.PrintCoreMetrics': 500,
	'belle_vip.stats_mail_global.StatsMailer': 505,
}
