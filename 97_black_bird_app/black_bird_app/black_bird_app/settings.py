# -*- coding: utf-8 -*-
BOT_NAME='black_bird_app'
SPIDER_MODULES=['black_bird_app.spiders']
NEWSPIDER_MODULE='black_bird_app.spiders'
...
ITEM_PIPELINES= {
	'black_bird_app.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'black_bird_app.stats_collector_global.PrintCoreMetrics': 500,
	'black_bird_app.stats_mail_global.StatsMailer': 505,
}
