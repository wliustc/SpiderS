# -*- coding: utf-8 -*-
BOT_NAME='fang_shop'
SPIDER_MODULES=['fang_shop.spiders']
NEWSPIDER_MODULE='fang_shop.spiders'
...
ITEM_PIPELINES= {
	'fang_shop.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'fang_shop.stats_collector_global.PrintCoreMetrics': 500,
	'fang_shop.stats_mail_global.StatsMailer': 505,
}
