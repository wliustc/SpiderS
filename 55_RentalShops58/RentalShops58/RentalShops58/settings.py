# -*- coding: utf-8 -*-
BOT_NAME='RentalShops58'
SPIDER_MODULES=['RentalShops58.spiders']
NEWSPIDER_MODULE='RentalShops58.spiders'
...
ITEM_PIPELINES= {
	'RentalShops58.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'RentalShops58.stats_collector_global.PrintCoreMetrics': 500,
	'RentalShops58.stats_mail_global.StatsMailer': 505,
}
