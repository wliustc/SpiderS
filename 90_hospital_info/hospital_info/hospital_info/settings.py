# -*- coding: utf-8 -*-
BOT_NAME='hospital_info'
SPIDER_MODULES=['hospital_info.spiders']
NEWSPIDER_MODULE='hospital_info.spiders'
...
ITEM_PIPELINES= {
	'hospital_info.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'hospital_info.stats_collector_global.PrintCoreMetrics': 500,
	'hospital_info.stats_mail_global.StatsMailer': 505,
}
