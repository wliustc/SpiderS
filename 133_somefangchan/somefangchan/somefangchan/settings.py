# -*- coding: utf-8 -*-
BOT_NAME='somefangchan'
SPIDER_MODULES=['somefangchan.spiders']
NEWSPIDER_MODULE='somefangchan.spiders'
...
ITEM_PIPELINES= {
	'somefangchan.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'somefangchan.stats_collector_global.PrintCoreMetrics': 500,
	'somefangchan.stats_mail_global.StatsMailer': 505,
}
