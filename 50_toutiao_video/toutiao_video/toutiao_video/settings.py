# -*- coding: utf-8 -*-
BOT_NAME='toutiao_video'
SPIDER_MODULES=['toutiao_video.spiders']
NEWSPIDER_MODULE='toutiao_video.spiders'
...
ITEM_PIPELINES= {
	'toutiao_video.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'toutiao_video.stats_collector_global.PrintCoreMetrics': 500,
	'toutiao_video.stats_mail_global.StatsMailer': 505,
}
