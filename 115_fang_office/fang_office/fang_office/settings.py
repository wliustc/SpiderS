# -*- coding: utf-8 -*-
BOT_NAME='fang_office'
SPIDER_MODULES=['fang_office.spiders']
NEWSPIDER_MODULE='fang_office.spiders'
...
ITEM_PIPELINES= {
	'fang_office.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'fang_office.stats_collector_global.PrintCoreMetrics': 500,
	'fang_office.stats_mail_global.StatsMailer': 505,
}
