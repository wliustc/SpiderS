# -*- coding: utf-8 -*-
BOT_NAME='BaiDuMap'
SPIDER_MODULES=['BaiDuMap.spiders']
NEWSPIDER_MODULE='BaiDuMap.spiders'
...
ITEM_PIPELINES= {
	'BaiDuMap.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'BaiDuMap.stats_collector_global.PrintCoreMetrics': 500,
	'BaiDuMap.stats_mail_global.StatsMailer': 505,
}
