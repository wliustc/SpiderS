# -*- coding: utf-8 -*-
BOT_NAME='pptv'
SPIDER_MODULES=['pptv.spiders']
NEWSPIDER_MODULE='pptv.spiders'
...
ITEM_PIPELINES= {
	'pptv.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'pptv.stats_collector_global.PrintCoreMetrics': 500,
	'pptv.stats_mail_global.StatsMailer': 505,
}
