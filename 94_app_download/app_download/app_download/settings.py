# -*- coding: utf-8 -*-
BOT_NAME='app_download'
SPIDER_MODULES=['app_download.spiders']
NEWSPIDER_MODULE='app_download.spiders'
...
ITEM_PIPELINES= {
	'app_download.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'app_download.stats_collector_global.PrintCoreMetrics': 500,
	'app_download.stats_mail_global.StatsMailer': 505,
}
