# -*- coding: utf-8 -*-
BOT_NAME='shebaoyiyuan'
SPIDER_MODULES=['shebaoyiyuan.spiders']
NEWSPIDER_MODULE='shebaoyiyuan.spiders'
...
ITEM_PIPELINES= {
	'shebaoyiyuan.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'shebaoyiyuan.stats_collector_global.PrintCoreMetrics': 500,
	'shebaoyiyuan.stats_mail_global.StatsMailer': 505,
}
