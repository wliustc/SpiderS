...
import time
class ShebaoJigouShanghaiSpider(scrapy.Spider):
    name = "shebao_jigou_shanghai"
    ...
    def start_requests(self):
        headers = {
            ...
            'Referer':'http://ybj.sh.gov.cn/xxcx/ddyy.jsp',
            'Upgrade-Insecure-Requests':'1',
            'User-Agent':'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.96 Safari/537.36',
        }
        yield scrapy.FormRequest('http://ybj.sh.gov.cn/xxcx/ddyy.jsp',
        formdata={'pageno':'1','qxcode':'01','grade':'','unitname':'','address':''},
    ...
    def parse_item(self, response):
        ...
        trs=response.xpath("//table[@bgcolor]//tr[@bgcolor='#FFFFFF']")
        for tr in trs:
            ...
            if tr.xpath('td[2]/text()').extract()[0] !='null':
                ...
                item['sort']=tr.xpath('td[4]/text()').extract()[0]
