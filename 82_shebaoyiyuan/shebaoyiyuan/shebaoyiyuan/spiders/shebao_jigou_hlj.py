...
import time
class ShebaoJgHljSpider(scrapy.Spider):
    name = "shebao_jigou_hlj"
    allowed_domains = ["www.hl.lss.gov.cn"]


    def start_requests(self):
        yield scrapy.Request('http://www.hl.lss.gov.cn/hljsyb/list.jsp?type=yy',dont_filter=True)
    ...
    def parser_country(self,response):
        ...
        for temp in temps:
            ...
            url='http://www.hl.lss.gov.cn/hljsyb/listView.jsp?type=yy&id='+value
            yield scrapy.Request(url, dont_filter=True,
