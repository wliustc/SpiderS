# -*- coding: utf-8 -*-
BOT_NAME='gaode_index'
SPIDER_MODULES=['gaode_index.spiders']
NEWSPIDER_MODULE='gaode_index.spiders'
...
ITEM_PIPELINES= {
	'gaode_index.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'gaode_index.stats_collector_global.PrintCoreMetrics': 500,
	'gaode_index.stats_mail_global.StatsMailer': 505,
}
