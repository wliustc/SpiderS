# -*- coding: utf-8 -*-
BOT_NAME='ChongYiSheng'
SPIDER_MODULES=['ChongYiSheng.spiders']
NEWSPIDER_MODULE='ChongYiSheng.spiders'
...
ITEM_PIPELINES= {
	'ChongYiSheng.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'ChongYiSheng.stats_collector_global.PrintCoreMetrics': 500,
	'ChongYiSheng.stats_mail_global.StatsMailer': 505,
}
