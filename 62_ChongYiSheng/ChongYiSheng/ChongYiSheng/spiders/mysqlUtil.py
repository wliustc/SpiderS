...
class Mysql(object):
    ...
    def __init__(self,DBHOST, DBPORT, DBUSER, DBPWD, DBNAME, DBCHAR):
        """
    ...
    def __getConn(self):
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=MySQLdb, mincached=1, maxcached=20,
                              host=self.DBHOST, port=self.DBPORT, user=self.DBUSER, passwd=self.DBPWD,
                              db=self.DBNAME, use_unicode=False, charset=self.DBCHAR, cursorclass=DictCursor)
