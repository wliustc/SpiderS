# -*- coding: utf-8 -*-
BOT_NAME='bailingniao'
SPIDER_MODULES=['bailingniao.spiders']
NEWSPIDER_MODULE='bailingniao.spiders'
...
ITEM_PIPELINES= {
	'bailingniao.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'bailingniao.stats_collector_global.PrintCoreMetrics': 500,
	'bailingniao.stats_mail_global.StatsMailer': 505,
}
