# -*- coding: utf-8 -*-
BOT_NAME='pet_hospital'
SPIDER_MODULES=['pet_hospital.spiders']
NEWSPIDER_MODULE='pet_hospital.spiders'
...
ITEM_PIPELINES= {
	'pet_hospital.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'pet_hospital.stats_collector_global.PrintCoreMetrics': 500,
	'pet_hospital.stats_mail_global.StatsMailer': 505,
}
