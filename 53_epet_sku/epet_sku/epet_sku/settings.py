# -*- coding: utf-8 -*-
BOT_NAME='epet_sku'
SPIDER_MODULES=['epet_sku.spiders']
NEWSPIDER_MODULE='epet_sku.spiders'
...
ITEM_PIPELINES= {
	'epet_sku.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'epet_sku.stats_collector_global.PrintCoreMetrics': 500,
	'epet_sku.stats_mail_global.StatsMailer': 505,
}
