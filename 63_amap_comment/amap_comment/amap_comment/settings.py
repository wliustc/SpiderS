# -*- coding: utf-8 -*-
BOT_NAME='amap_comment'
SPIDER_MODULES=['amap_comment.spiders']
NEWSPIDER_MODULE='amap_comment.spiders'
...
ITEM_PIPELINES= {
	'amap_comment.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'amap_comment.stats_collector_global.PrintCoreMetrics': 500,
	'amap_comment.stats_mail_global.StatsMailer': 505,
}
