# -*- coding: utf-8 -*-
BOT_NAME='liangping'
SPIDER_MODULES=['liangping.spiders']
NEWSPIDER_MODULE='liangping.spiders'
...
ITEM_PIPELINES= {
	'liangping.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'liangping.stats_collector_global.PrintCoreMetrics': 500,
	'liangping.stats_mail_global.StatsMailer': 505,
}
