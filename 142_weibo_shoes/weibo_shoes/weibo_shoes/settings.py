# -*- coding: utf-8 -*-
BOT_NAME='weibo_shoes'
SPIDER_MODULES=['weibo_shoes.spiders']
NEWSPIDER_MODULE='weibo_shoes.spiders'
...
ITEM_PIPELINES= {
	'weibo_shoes.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'weibo_shoes.stats_collector_global.PrintCoreMetrics': 500,
	'weibo_shoes.stats_mail_global.StatsMailer': 505,
}
