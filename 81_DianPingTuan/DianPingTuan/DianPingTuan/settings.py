# -*- coding: utf-8 -*-
BOT_NAME='DianPingTuan'
SPIDER_MODULES=['DianPingTuan.spiders']
NEWSPIDER_MODULE='DianPingTuan.spiders'
...
ITEM_PIPELINES= {
	'DianPingTuan.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'DianPingTuan.stats_collector_global.PrintCoreMetrics': 500,
	'DianPingTuan.stats_mail_global.StatsMailer': 505,
}
