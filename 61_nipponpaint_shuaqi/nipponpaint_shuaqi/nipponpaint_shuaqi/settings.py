# -*- coding: utf-8 -*-
BOT_NAME='nipponpaint_shuaqi'
SPIDER_MODULES=['nipponpaint_shuaqi.spiders']
NEWSPIDER_MODULE='nipponpaint_shuaqi.spiders'
...
ITEM_PIPELINES= {
	'nipponpaint_shuaqi.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'nipponpaint_shuaqi.stats_collector_global.PrintCoreMetrics': 500,
	'nipponpaint_shuaqi.stats_mail_global.StatsMailer': 505,
}
