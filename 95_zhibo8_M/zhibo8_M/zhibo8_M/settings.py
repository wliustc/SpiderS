# -*- coding: utf-8 -*-
BOT_NAME='zhibo8_M'
SPIDER_MODULES=['zhibo8_M.spiders']
NEWSPIDER_MODULE='zhibo8_M.spiders'
...
ITEM_PIPELINES= {
	'zhibo8_M.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'zhibo8_M.stats_collector_global.PrintCoreMetrics': 500,
	'zhibo8_M.stats_mail_global.StatsMailer': 505,
}
