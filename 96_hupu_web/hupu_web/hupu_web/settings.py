# -*- coding: utf-8 -*-
BOT_NAME='hupu_web'
SPIDER_MODULES=['hupu_web.spiders']
NEWSPIDER_MODULE='hupu_web.spiders'
...
ITEM_PIPELINES= {
	'hupu_web.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'hupu_web.stats_collector_global.PrintCoreMetrics': 500,
	'hupu_web.stats_mail_global.StatsMailer': 505,
}
