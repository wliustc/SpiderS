# -*- coding: utf-8 -*-
BOT_NAME='zhibo8'
SPIDER_MODULES=['zhibo8.spiders']
NEWSPIDER_MODULE='zhibo8.spiders'
...
ITEM_PIPELINES= {
	'zhibo8.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'zhibo8.stats_collector_global.PrintCoreMetrics': 500,
	'zhibo8.stats_mail_global.StatsMailer': 505,
}
