# -*- coding: utf-8 -*-
BOT_NAME='paint'
SPIDER_MODULES=['paint.spiders']
NEWSPIDER_MODULE='paint.spiders'
...
ITEM_PIPELINES= {
	'paint.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
MAIL_PASS="dev123"
EXTENSIONS= {
	'paint.stats_collector_global.PrintCoreMetrics': 500,
	'paint.stats_mail_global.StatsMailer': 505,
}
