# -*- coding: utf-8 -*-
BOT_NAME='toutiao_moments'
SPIDER_MODULES=['toutiao_moments.spiders']
NEWSPIDER_MODULE='toutiao_moments.spiders'
...
ITEM_PIPELINES= {
	'toutiao_moments.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'toutiao_moments.stats_collector_global.PrintCoreMetrics': 500,
	'toutiao_moments.stats_mail_global.StatsMailer': 505,
}
