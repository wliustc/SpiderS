# -*- coding: utf-8 -*-
BOT_NAME='tmall_shop'
SPIDER_MODULES=['tmall_shop.spiders']
NEWSPIDER_MODULE='tmall_shop.spiders'
...
ITEM_PIPELINES= {
	'tmall_shop.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'tmall_shop.stats_collector_global.PrintCoreMetrics': 500,
	'tmall_shop.stats_mail_global.StatsMailer': 505,
}
