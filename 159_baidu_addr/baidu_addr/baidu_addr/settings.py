# -*- coding: utf-8 -*-
BOT_NAME='baidu_addr'
SPIDER_MODULES=['baidu_addr.spiders']
NEWSPIDER_MODULE='baidu_addr.spiders'
...
ITEM_PIPELINES= {
	'baidu_addr.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'baidu_addr.stats_collector_global.PrintCoreMetrics': 500,
	'baidu_addr.stats_mail_global.StatsMailer': 505,
}
