...
class GPSCoordsConvertor(object):
    ...
    @staticmethod
    def convert_mc_2_gps(lng, lat):  #百米坐标转GPS
    ...
    @staticmethod
    def convert_gps_2_mc(lng, lat): #GPS转百度百米坐标
    ...
    @staticmethod
    def baidu_coord_2_gps(lng, lat): #百度坐标转GPS
        bd_x = lng - 0.0065
        bd_y = lat - 0.006
    ...
    @staticmethod
    def gps_2_baidu_coord(lng, lat): #GPS转百度坐标
        x = lng
        y = lat
    ...
    @staticmethod
    def convert_tencent_to_baidu(lng,lat):
...
if __name__ == '__main__':
    ...
    print ad.convert_mc_2_gps(12655277.3816,4116981.21796)
