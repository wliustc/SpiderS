# -*- coding: utf-8 -*-
BOT_NAME='boqi_jd'
SPIDER_MODULES=['boqi_jd.spiders']
NEWSPIDER_MODULE='boqi_jd.spiders'
...
ITEM_PIPELINES= {
	'boqi_jd.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'boqi_jd.stats_collector_global.PrintCoreMetrics': 500,
	'boqi_jd.stats_mail_global.StatsMailer': 505,
}
