# -*- coding: utf-8 -*-
BOT_NAME='fintech_zhilian'
SPIDER_MODULES=['fintech_zhilian.spiders']
NEWSPIDER_MODULE='fintech_zhilian.spiders'
...
ITEM_PIPELINES= {
	'fintech_zhilian.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'fintech_zhilian.stats_collector_global.PrintCoreMetrics': 500,
	'fintech_zhilian.stats_mail_global.StatsMailer': 505,
}
