# -*- coding: utf-8 -*-
BOT_NAME='ccxiong_jd'
SPIDER_MODULES=['ccxiong_jd.spiders']
NEWSPIDER_MODULE='ccxiong_jd.spiders'
...
ITEM_PIPELINES= {
	'ccxiong_jd.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'ccxiong_jd.stats_collector_global.PrintCoreMetrics': 500,
	'ccxiong_jd.stats_mail_global.StatsMailer': 505,
}
