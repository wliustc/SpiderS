# -*- coding: utf-8 -*-
BOT_NAME='tx_shippin'
SPIDER_MODULES=['tx_shippin.spiders']
NEWSPIDER_MODULE='tx_shippin.spiders'
...
ITEM_PIPELINES= {
	'tx_shippin.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'tx_shippin.stats_collector_global.PrintCoreMetrics': 500,
	'tx_shippin.stats_mail_global.StatsMailer': 505,
}
