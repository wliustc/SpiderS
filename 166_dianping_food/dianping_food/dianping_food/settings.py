# -*- coding: utf-8 -*-
BOT_NAME='dianping_food'
SPIDER_MODULES=['dianping_food.spiders']
NEWSPIDER_MODULE='dianping_food.spiders'
...
ITEM_PIPELINES= {
	'dianping_food.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'dianping_food.stats_collector_global.PrintCoreMetrics': 500,
	'dianping_food.stats_mail_global.StatsMailer': 505,
}
