# -*- coding: utf-8 -*-
BOT_NAME='meituan_pet_server'
SPIDER_MODULES=['meituan_pet_server.spiders']
NEWSPIDER_MODULE='meituan_pet_server.spiders'
...
ITEM_PIPELINES= {
	'meituan_pet_server.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'meituan_pet_server.stats_collector_global.PrintCoreMetrics': 500,
	'meituan_pet_server.stats_mail_global.StatsMailer': 505,
}
