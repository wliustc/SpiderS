# -*- coding: utf-8 -*-
BOT_NAME='dentist_guahao'
SPIDER_MODULES=['dentist_guahao.spiders']
NEWSPIDER_MODULE='dentist_guahao.spiders'
...
ITEM_PIPELINES= {
	'dentist_guahao.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'dentist_guahao.stats_collector_global.PrintCoreMetrics': 500,
	'dentist_guahao.stats_mail_global.StatsMailer': 505,
}
