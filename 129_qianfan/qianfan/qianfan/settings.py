# -*- coding: utf-8 -*-
BOT_NAME='qianfan'
SPIDER_MODULES=['qianfan.spiders']
NEWSPIDER_MODULE='qianfan.spiders'
...
ITEM_PIPELINES= {
	'qianfan.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'qianfan.stats_collector_global.PrintCoreMetrics': 500,
	'qianfan.stats_mail_global.StatsMailer': 505,
}
