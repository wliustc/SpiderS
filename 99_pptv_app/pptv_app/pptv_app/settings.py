# -*- coding: utf-8 -*-
BOT_NAME='pptv_app'
SPIDER_MODULES=['pptv_app.spiders']
NEWSPIDER_MODULE='pptv_app.spiders'
...
ITEM_PIPELINES= {
	'pptv_app.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'pptv_app.stats_collector_global.PrintCoreMetrics': 500,
	'pptv_app.stats_mail_global.StatsMailer': 505,
}
