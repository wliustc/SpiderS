# -*- coding: utf-8 -*-
BOT_NAME='baidu_API'
SPIDER_MODULES=['baidu_API.spiders']
NEWSPIDER_MODULE='baidu_API.spiders'
...
ITEM_PIPELINES= {
	'baidu_API.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'baidu_API.stats_collector_global.PrintCoreMetrics': 500,
	'baidu_API.stats_mail_global.StatsMailer': 505,
}
