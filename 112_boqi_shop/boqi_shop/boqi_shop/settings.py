# -*- coding: utf-8 -*-
BOT_NAME='boqi_shop'
SPIDER_MODULES=['boqi_shop.spiders']
NEWSPIDER_MODULE='boqi_shop.spiders'
...
ITEM_PIPELINES= {
	'boqi_shop.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'boqi_shop.stats_collector_global.PrintCoreMetrics': 500,
	'boqi_shop.stats_mail_global.StatsMailer': 505,
}
