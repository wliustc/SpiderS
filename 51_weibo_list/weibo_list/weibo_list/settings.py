# -*- coding: utf-8 -*-
BOT_NAME='weibo_list'
SPIDER_MODULES=['weibo_list.spiders']
NEWSPIDER_MODULE='weibo_list.spiders'
...
ITEM_PIPELINES= {
	'weibo_list.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'weibo_list.stats_collector_global.PrintCoreMetrics': 500,
	'weibo_list.stats_mail_global.StatsMailer': 505,
}
