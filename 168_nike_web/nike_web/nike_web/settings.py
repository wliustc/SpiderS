# -*- coding: utf-8 -*-
BOT_NAME='nike_web'
SPIDER_MODULES=['nike_web.spiders']
NEWSPIDER_MODULE='nike_web.spiders'
...
ITEM_PIPELINES= {
	'nike_web.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'nike_web.stats_collector_global.PrintCoreMetrics': 500,
	'nike_web.stats_mail_global.StatsMailer': 505,
}
