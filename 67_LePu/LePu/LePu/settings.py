# -*- coding: utf-8 -*-
BOT_NAME='LePu'
SPIDER_MODULES=['LePu.spiders']
NEWSPIDER_MODULE='LePu.spiders'
...
ITEM_PIPELINES= {
	'LePu.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'LePu.stats_collector_global.PrintCoreMetrics': 500,
	'LePu.stats_mail_global.StatsMailer': 505,
}
