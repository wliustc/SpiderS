# -*- coding: utf-8 -*-
BOT_NAME='yuedongApp'
SPIDER_MODULES=['yuedongApp.spiders']
NEWSPIDER_MODULE='yuedongApp.spiders'
...
ITEM_PIPELINES= {
	'yuedongApp.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'yuedongApp.stats_collector_global.PrintCoreMetrics': 500,
	'yuedongApp.stats_mail_global.StatsMailer': 505,
}
