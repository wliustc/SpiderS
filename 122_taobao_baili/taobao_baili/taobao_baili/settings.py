# -*- coding: utf-8 -*-
BOT_NAME='taobao_baili'
SPIDER_MODULES=['taobao_baili.spiders']
NEWSPIDER_MODULE='taobao_baili.spiders'
...
ITEM_PIPELINES= {
	'taobao_baili.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'taobao_baili.stats_collector_global.PrintCoreMetrics': 500,
	'taobao_baili.stats_mail_global.StatsMailer': 505,
}
