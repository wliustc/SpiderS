...
class HuaniaoSpider(scrapy.Spider):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.data_api = 'https://s.taobao.com/list?data-key=s&data-value={page}&ajax=true&_ksTS={time}&callback=jsonp{random}&q={key}&cat=29%2C50007216&style=grid&seller_type=taobao&spm=a219r.lm5059.1000187.1&cps=yes&ppath={key_word}&loc={city}&bcoffset=12&filter_tianmao=tmall'
