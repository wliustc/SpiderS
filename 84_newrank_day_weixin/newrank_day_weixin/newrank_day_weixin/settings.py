# -*- coding: utf-8 -*-
BOT_NAME='newrank_day_weixin'
SPIDER_MODULES=['newrank_day_weixin.spiders']
NEWSPIDER_MODULE='newrank_day_weixin.spiders'
...
ITEM_PIPELINES= {
	'newrank_day_weixin.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'newrank_day_weixin.stats_collector_global.PrintCoreMetrics': 500,
	'newrank_day_weixin.stats_mail_global.StatsMailer': 505,
}
