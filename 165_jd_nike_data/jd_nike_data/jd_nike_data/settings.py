# -*- coding: utf-8 -*-
BOT_NAME='jd_nike_data'
SPIDER_MODULES=['jd_nike_data.spiders']
NEWSPIDER_MODULE='jd_nike_data.spiders'
...
ITEM_PIPELINES= {
	'jd_nike_data.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'jd_nike_data.stats_collector_global.PrintCoreMetrics': 500,
	'jd_nike_data.stats_mail_global.StatsMailer': 505,
}
