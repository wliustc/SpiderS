...
from jd_nike_data.items import JdNikeDataItem
import json
reload(sys)
...
class JdNikeSpider(scrapy.Spider):
    name = 'jd_nike'
    def start_requests(self):
        url = 'https://module-jshop.jd.com/module/allGoods/goods.html?appId=1005989&pageInstanceId=103275864&searchWord=&pageNo=1&direction=1&instanceId=103275867&modulePrototypeId=55555&moduleTemplateId=905542'
    ...
    def parse(self, response):
        ...
        if count:
            ...
            for i in xrange(1, count):
                url = 'https://module-jshop.jd.com/module/allGoods/goods.html?appId=1005989&pageInstanceId=103275864&searchWord=&pageNo=' + str(
                    i) + '&direction=1&instanceId=103275867&modulePrototypeId=55555&moduleTemplateId=905542'
                headers = {
    ...
    def parse_content(self, response):
        ...
        if url_list:
            for base_url in url_list:
                ...
                yield scrapy.Request(base_url, headers=headers, meta={'base_url': base_url}, callback=self.parse_item,
                                     dont_filter=True)
...
#        html= response.body
        ...
        if shop:
            ...
            if id:
                ...
                meta_info = {'id': shop_id, 'base_url': base_url, 'product_code': product_code,
    ...
    def parse_all(self, response):
        ...
        shop_name = meta_info.get('shop_name')
        product_code = meta_info.get('product_code')
        product_code1 = re.search(product_code + r'-\w+', shop_name)
        if product_code1:
            product_code1 = product_code1.group()
            item['product_code1'] = product_code1
        item['price'] = price
        item["shop_id"] = meta_info.get('id')
        item['url'] = meta_info.get('base_url')
