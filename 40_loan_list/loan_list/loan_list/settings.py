# -*- coding: utf-8 -*-
BOT_NAME='loan_list'
SPIDER_MODULES=['loan_list.spiders']
NEWSPIDER_MODULE='loan_list.spiders'
...
ITEM_PIPELINES= {
	'loan_list.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'loan_list.stats_collector_global.PrintCoreMetrics': 500,
	'loan_list.stats_mail_global.StatsMailer': 505,
}
