...
ITEM_PIPELINES= {
	'weather_report.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'weather_report.stats_collector_global.PrintCoreMetrics': 500,
	'weather_report.stats_mail_global.StatsMailer': 505,
}
