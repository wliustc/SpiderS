...
class WriteFilePipeline(object):
    def __init__(self,save_path,max_size,project,task_id,task_date,hdfs_path,hdfs_ip,hdfs_port):
        self.dir = save_path
        self.hdfs_module = hdfs_path.strip()
        self.hdfs_port = hdfs_port.strip()
        self.hdfs_ip = hdfs_ip.strip()
        save_path = save_path+"/{}/{}/{}".format(project,task_date.strip(),task_id)
