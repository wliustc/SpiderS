# -*- coding: utf-8 -*-
BOT_NAME='gudong_spider'
SPIDER_MODULES=['gudong_spider.spiders']
NEWSPIDER_MODULE='gudong_spider.spiders'
...
ITEM_PIPELINES= {
	'gudong_spider.pipelines_global.WriteFilePipeline': 300,
}
LOG_LEVEL='WARNING'
...
HDFS_MODULE="hdfs"
EXTENSIONS= {
	'gudong_spider.stats_collector_global.PrintCoreMetrics': 500,
	'gudong_spider.stats_mail_global.StatsMailer': 505,
}
